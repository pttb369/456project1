...
public class TFIDFHtmlIndexFiles {
	...
	public static void main(String[] args) throws SAXException {
		...
		try {
	  		...
	  		CMPT456Similarity cmpt456Similarity = new CMPT456Similarity();

	  		iwc.setSimilarity(cmpt456Similarity);
	...
	*/
	static void indexDocs(final IndexWriter writer, Path path) throws IOException, SAXException{
	...
	static void indexDoc(IndexWriter writer, Path file, long lastModified) throws IOException, SAXException {
